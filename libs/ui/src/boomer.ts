...
import type { queries, themeTypeForV } from './theme';
...
export function css<TVariants extends Variants>(
    ...
    let cssOut = `@layer tokenBase, tokenMedia, reset, base, variants, compoundVariants; @layer base {${styles.base ? buildCSS(styles.base, '.&') : ''}}`
    if (styles.variants) {
